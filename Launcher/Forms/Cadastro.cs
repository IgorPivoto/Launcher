...
namespace Launcher
{
    public partial class Cadastro : Form
    {
        ...
        {
            string nome = Criptografiaa(Tbxnome.Text.Trim());
            string email = Criptografiaa(TbxEmail.Text.Trim());
            string senha = Criptografiaa(TbxSenha.Text);
            string confimarsenha = Criptografiaa(TbxconfirmaSenha.Text.Trim());
